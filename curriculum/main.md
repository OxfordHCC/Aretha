...
1) Service provision - the most obvious reason for collecting data is that it’s needed in order to provide you with a service (e.g. a company can’t charge you for something without your bank details)
...
![inform](figures/qr-right-access.png)
...
![inform](figures/qr-right-delete.png)
...
![inform](figures/qr-right-object.png)
...
Source: [1]
1) ![internet-1](figures/internet-1.png)
2) ![internet-2](figures/internet-2.png)
3) ![internet-3](figures/internet-3.png)
